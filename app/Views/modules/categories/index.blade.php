...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800 mb-n1">Categories</h1>
        <button class="btn btn-sm btn-primary btn-create">Create Category</button>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" name="name" required
                                autocomplete="name" autofocus autofocus placeholder="Enter category name...">
                        </div>
                        ...
                        {{-- <div class="form-group">
                            <div class="custom-file">
                                <label for="image" class="col-form-label">category Logo:</label>
...
@push('scripts')
    ...
    {{-- sweet alert --}}
    <script src="{{ base_url('vendors/plugins/sweetalert2/sweet-alert.init.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btn-create', function(e) {
            ...
            $('#category-form').attr({
                action: '{{ route_to('categorys.create') }}',
                method: 'POST'
            });
