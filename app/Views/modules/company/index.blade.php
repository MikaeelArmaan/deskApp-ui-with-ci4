...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 text-gray-800 mb-n1">Companies</h1>
        <button class="btn btn-sm btn-primary btn-create">Create company</button>
    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control" name="name" required
                                autocomplete="name" autofocus autofocus placeholder="Enter company name...">
                        </div>
                        ...
                        {{-- <div class="form-group">
                            <div class="custom-file">
                                <label for="image" class="col-form-label">company Logo:</label>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.btn-create', function(e) {
            ...
            $('#company-form').attr({
                action: '{{ route_to('companys.create') }}',
                method: 'POST'
            });
