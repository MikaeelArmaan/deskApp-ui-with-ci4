<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
        <a class="dropdown-item text-warning btn-edit" href="#" data-items="{{ json_encode($data) }}"
            data-url="{{ route_to('permissions.update', $data->id) }}"><i class="dw dw-edit2"></i> Edit</a>
        <a class="dropdown-item text-danger" href="#"
            data-url="{{ route_to('permissions.delete', $data->id) }}"><i class="dw dw-delete-3"></i> Delete</a>
    </div>
</div>
